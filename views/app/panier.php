...
if (empty($_SESSION['panier'])) {
    echo '<p> Votre panier est vide, remplissez le vite ! 
                <a class="btn btn-success" href="' . BASE_PATH . '"> Accès à la boutique </a> 
            </p>';
} else {
?>
    ...
    ?>
        <a href="<?= BASE_PATH . 'user/connexion?commande=true' ?>" class="btn btn-warning"> Connectez-vous pour passer la commande </a>
    <?php
    }
    ?>
